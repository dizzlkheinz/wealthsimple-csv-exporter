...
```
3. **Name it**: You might want to call it `Export Wealthsimple CSV`

4. Visit your Wealthsimple transactions page, apply whatever filters you want on the website, scroll down to load more transactions as far back as you want to go, and click the bookmarklet!
